...
INSERT INTO LABEL VALUES (SQ_LABEL.nextval, 1, 'RCA/Jive Label Group', 'http://','RCA Records (originally The Victor Talking Machine Company, then RCA Victor) is one of the flagship labels of Sony Music Entertainment. The RCA initials stand for Radio Corporation of America (later renamed RCA Corporation), which was the parent corporation from 1929[1]  to 1983 and a partner from 1983 to 1986.');
INSERT INTO LABEL VALUES (SQ_LABEL.nextval, 5, 'Domino Records', 'http://','Domino Recording Company, generally known as Domino Records, is an independent record label based in London. There is also a wing of the label based in United States, releasing Domino artists music from the labels Brooklyn  offices and run by Kris Gillespie. In addition, Stephen Pastel presides over the subsidiary label Geographic Music, which releases more unusual British and World music.');
